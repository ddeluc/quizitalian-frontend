    ...
    <>
      <div className="h-footer w-screen border flex justify-between items-center font-geologica border-slate-200">
        ...
        <div className="flex space-x-3 mr-6">
          <p className="font-light text-base">quizitalian.dev@gmail.com</p>
          <a href='https://github.com/ddeluc' target="_blank">
            <svg
          ...
          <a href='http://www.linkedin.com/in/danterdeluca' target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"                
              className="h-6 w-6"
              fill="#1e293b"
